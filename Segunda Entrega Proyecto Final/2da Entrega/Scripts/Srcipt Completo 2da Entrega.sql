...
INSERT INTO jugadores(`id_jugador`,`nombre`,`apellido`,`posicion`,`edad`,`peso`,`altura`,`fecha_nacimiento`,`fecha_contrato`,`nacionalidad`,`pie`,`partidos_jugados`,`goles`,`asistencias`,`id_futbol`,`id_instituto`) VALUES (16,'Rodrigo','Aliendro','Mediocentro',31,72,1.73,'16/2/91','31/12/25','Argentina','Derecho',13,1,1,1,NULL);
...
#######################################
### Nuevas tablas para segunda entrega
######################################
...
# Ingreso de datos de tabla Paises
...
`altura`,`fecha_nacimiento`,`fecha_contrato`,`nacionalidad`,`pie`,`partidos_jugados`,`goles`,`asistencias`,`id_futbol`,`id_instituto`)
values (NEW.id_jugador, NEW.nombre, NEW.apellido, NEW.posicion, new.edad, new.peso,new.altura,
 new.fecha_nacimiento, new.fecha_contrato, new.nacionalidad, new.pie, new.partidos_jugados, new.goles, 
 new.asistencias, new.id_futbol, new.id_instituto);
 
Select * From Jugadores;

INSERT INTO jugadores VALUES (NULL,'Manuel','Lanzini','Mediocentro Ofensivo',31,70,1.70,'11/04/91','31/12/26','Argentina','Derecho',58,5,3,1,NULL);
